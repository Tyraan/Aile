...
function _initChinaOver(){
	
	   window.chinadt = $("#china dt");
       
	   window.chinddd = $("#china dd");
	   ...
	   window.chinddd.hover(function(){
			...
			window.chinadt.addClass($id);
 
	  },function(){	
	  			   
		    if(flag==1){ return false;}	   
				   			
		    window.chinadt.removeClass();
...
// 显示城市
function _initChinaProvince(){
        
		$("#chinaprovince span").click(function(){
			   ...
			   if($pid<=2000){
				  ...
				  $("#chinaprovince dl span").removeClass("s")

				  $("#chinaprovince dl").addClass("s");
				  
				  $(this).addClass("s");
				  
				  $("#chinacitylist").insertAfter($(this).parent());
...
function showChinaCity(pid){
				   ...
				   $("#chinacitylist").html(html);

				   $("#chinacitylist span").click(function(){
...
function _initOpen(){
	  ...
	  $("#allow").click(function(){
	       ...
	       if(flag==1){    
		          ...
		          $("#allow").attr("title","չ���б�");     
				  
				  $("#allow").html("չ���б�");  
			
			      $("#chinalist").animate({left:-258},500); 
                  
				  flag=0;  
				  $("#allow").addClass("allow2");
				  $("#allow").removeClass("allow1");
				   window.chinddd.show();      
		     }else{         
				  ...
				  $("#chinalist").animate({left:0},500); 
                  $("#allow").addClass("allow1");
				  	  $("#allow").removeClass("allow2");
				  flag=1;     
			 }
	  })
}
...
function showChinaCenerter($pid){
...
function chinaShow(){
        ...
        // 右边显示
		var html ="<dl id='chinacenterlist'><dt>金宝�?"+window.dataObj.city.cityname+"店铺�?<span></span></dt>"+h+"</dl>";
		 
	    $("#chinaprovince").html(html);
...
function initMap(){
 ...
 //创建地图函数�?
    function createMap(){
        ...
        map = new BMap.Map("china");                                   //在百度地图容器中创建一个地�?
    ...
    function createIcon(i,u){
        ...
        var icon = new BMap.Icon("/images/china/"+icon+".png", new BMap.Size(21,26),{imageOffset:new BMap.Size(0,ii)})
...
function _initOpen1(){
			      ...
			      $("#chinalist").animate({right:-258},500); 
				   flag=0;  
