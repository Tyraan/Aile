...
function _initchina2Over(){
	
	   window.china2dt = $("#china2 dt");
       
	   window.chinddd = $("#china2 dd");
	   ...
	   window.chinddd.hover(function(){
			...
			window.china2dt.addClass($id);
 
	  },function(){	
	  			   
		    if(flag==1){ return false;}	   
				   			
		    window.china2dt.removeClass();
...
// 显示城市
function _initchina2Province(){
        
		$("#china2province span").click(function(){
			   ...
			   if($pid<=2000){
				  ...
				  $("#china2province dl span").removeClass("s")

				  $("#china2province dl").addClass("s");
				  
				  $(this).addClass("s");
				  
				  $("#china2citylist").insertAfter($(this).parent());
...
function showchina2City(pid){
				   ...
				   $("#china2citylist").html(html);

				   $("#china2citylist span").click(function(){
...
function _initOpen4(){
	  ...
	  $("#allow3").click(function(){
		  
	       if(flag==1){    
		   
		          $("#allow3").attr("title","չ���б�");     
				  
				  $("#allow3").html("չ���б�");  
			
			      $("#chinalist2").animate({right:-258},500); 
                  
				  flag=0;  
				  $("#allow3").addClass("allow1");
				  $("#allow3").removeClass("allow3");
				   window.chinddd.show();      
		     }else{         
				  ...
				  $("#chinalist2").animate({right:0},500); 
                  $("#allow3").addClass("allow3");
				  	  $("#allow3").removeClass("allow1");
				  flag=1;     
			 }
	  })
}
...
function showchina2Cenerter($pid){
...
function china2Show(){
        ...
        // 右边显示
		var html ="<dl id='china2centerlist'><dt>金宝�?"+window.dataObj.city.cityname+"店铺�?<span></span></dt>"+h+"</dl>";
		 
	    $("#china2province").html(html);
...
function initMap(){
 ...
 //创建地图函数�?
    function createMap(){
        ...
        map = new BMap.Map("china2");                                   //在百度地图容器中创建一个地�?
    ...
    function createIcon(i,u){
        ...
        var icon = new BMap.Icon("/images/china2/"+icon+".png", new BMap.Size(21,26),{imageOffset:new BMap.Size(0,ii)})
