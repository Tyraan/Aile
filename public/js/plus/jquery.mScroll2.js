...
(function($) {
	$.fn.mScroll2 = function(options) {
		var opts = $.extend({},$.fn.mScroll2.defaults,options); 
		this.each(function(){
			//初始化
			...
			if(opts.direction=="h"){
				...
				s.css({width:w*size*2,height:c.height()});
				f.css({height:c.height()});
				ww=c.size()*w;
			}
			if(opts.direction=="v"){
				...
				s.css({height:h*size*2,width:"100%"});
				f.css({width:"100%"})
				hh=c.size()*h;
			}			
			...
			function rs(){
				...
				ww=c.size()*w;
				hh=c.size()*h;
				if(opts.direction=="h"){s.stop().css({left:idx*w*-1});}
				if(opts.direction=="v"){s.stop().css({top:idx*h*-1});}
						...
						if(act=="left"){
							if(opts.cycle!=1){
								if(idx+opts.minsize<size){
									idx++;
									s.animate({left:parseInt(s.css("left"))-w},opts.speed,opts.easing,function(){sw=1;});
								}
								else{sw=1;}
							}
							if(opts.cycle==1){	
								...
								if(parseInt(s.css("left"))*-1==ww*0.5){s.css("left",0);}								
								s.animate({left:parseInt(s.css("left"))-w},opts.speed,opts.easing,function(){sw=1;});
							}
						}
						if(act=="right"){
							...
							if(opts.cycle==1){
								...
								if(opts.cycle==1 && parseInt(s.css("left"))==0){s.css("left",ww*0.5*-1);}
								s.animate({left:parseInt(s.css("left"))+w},opts.speed,opts.easing,function(){sw=1;});
							}
						}						
					}
					if(opts.direction=="v"){
						if(act=="left"){
							if(opts.cycle!=1){
								if(idx+opts.minsize<size){
									if(opts)idx++;
									s.animate({top:parseInt(s.css("top"))-h},opts.speed,opts.easing,function(){sw=1;});
								}
								else{sw=1;}
							}
							if(opts.cycle==1){
								...
								if(parseInt(s.css("top"))==hh*0.5){s.css("top",0);}								
								s.animate({top:parseInt(s.css("top"))-h},opts.speed,opts.easing,function(){sw=1;});
							}	
						}
						if(act=="right"){
							...
							if(opts.cycle==1){
								...
								if(opts.cycle==1 && parseInt(s.css("top"))==0){f.scrollTop(hh*0.5);}								
								s.animate({top:parseInt(s.css("top"))+h},opts.speed,opts.easing,function(){sw=1;});
							}
						}
					}
			...
			n.each(function(index, element) {
				$(this).click(function(){
					if(opts.direction=="h"){s.stop().animate({left:index*w*-1},opts.speed,opts.easing,function(){sw=1;});}
					if(opts.direction=="v"){s.stop().animate({top:index*h*-1},opts.speed,opts.easing,function(){sw=1;});}
					idx=index;
					n.removeClass("now");
					n.eq(idx).addClass("now");
					if(opts.scrollnav){autonav();}
