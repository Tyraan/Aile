...
(function($) {
	$.fn.mScroll1 = function(options) {
		var opts = $.extend({},$.fn.mScroll1.defaults,options); 
		this.each(function(){
			//初始化
			...
			n = $(opts.nav);
			if(opts.scrollnav){
				w1 = n.outerWidth()+parseInt(n.css("margin-left"))+parseInt(n.css("margin-right"));
				h1 = n.outerHeight()+parseInt(n.css("margin-top"))+parseInt(n.css("margin-bottom"));
				np= $(opts.nav).parent();
