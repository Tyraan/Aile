		...
		function change(idx){
			if(c.size()>1 || idx=="begin"){
				...
				if(idx=="begin"){
					...
					speed=opts.speed;
					c.animate({opacity:"hide",marginLeft:-200},opts.speed-500,"easeInOutQuad");
					resets();//重置只定义动画元素
				}
				...
				c.eq(idx).delay(500).animate({opacity:"show",marginLeft:0},speed+200,"easeOutCubic",function(){
