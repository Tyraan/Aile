...
<div class="alkc_sp" id="alkc_sp_da" >
     ...
     <div class="alkc_sp_con">
          <!-- 代码 开始 -->
            <div class="sjqeka" onClick="tcc_show_sp()"><img src="/templates/default/images/tachuguanbi.png"></div>
            <object class id="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="1026" height="574">
              ...
              <param name="FlashVars" value="vcastr_file=/templates/default/images/lfjysp.flv&LogoText=www.lanrentuku.com&BufferTime=3&IsAutoPlay=1">
              <embed src="/templates/default/flvplayer.swf" allowfullscreen="true" flashvars="vcastr_file=/templates/default/images/lfjysp.flv&LogoText=www.lanrentuku.com&IsAutoPlay=1" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="1026" height="574"></embed>
            </object>
            <!-- 代码 结束 -->
     </div>
</div>
